...
%niftiwrite(rvolfix,  '3555525_multi.nii', 'Compressed',true);
...
for n = 250:251
    ...
    for z = 1:length(Allfiles_Exp)
        ...
        niftiwrite(volfix,  [filename,'/', g{1},'_multi.nii'], 'Compressed',true);
        niftiwrite(volmov,  [filename,'/', g{1},'_mov_multi.nii'], 'Compressed',true);
       ...
       [voldef_pl, Tmin_pl, Kmin_pl] = ptv_register(volmov, volfix, opts);
        ...
        niftiwrite(voldef_i, [filename,'/', g{1}, '_inter_rf_reg.nii'], 'Compressed',true);
