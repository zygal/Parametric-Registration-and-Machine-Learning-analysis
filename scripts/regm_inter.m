...
fixed_folder = '/home/saradh/Desktop/Thesis/matlab/first_visit/ref_fv/ref_male';
mov_folder = '/home/saradh/Desktop/Thesis/matlab/first_visit';
results = '/home/saradh/Desktop/Thesis/matlab/results/latitudinal/male_res/test';
filename = fullfile(results);


[X_f, META1] = nrrdread([fixed_folder,'/3555525_F.nrrd']);
[X_w, META2] = nrrdread([fixed_folder,'/3555525_W.nrrd']);
volfix = cat(4,X_f,X_w);

maskfix = readVTK([fixed_folder,'/3555525_mask.vtk']);
